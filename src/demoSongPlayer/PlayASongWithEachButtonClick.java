...
public class PlayASongWithEachButtonClick extends JFrame {
	...
	// baseDir will be the absolute folder no matter where this project moves to.
	...
	public void populateList() { // TODO: Hey Ben, you might want to remove some of your songs before turning it in! :D
		...
		audioFileNames.add(baseDir + "Dumbfoundead - IT G MA (Remix ft Keith Ape, A$AP Ferg, Father, & Waka Flocka Flame).mp3");
		audioFileNames.add(baseDir + "Funkovsky ft. Temu - Looking at Me.mp3");
		audioFileNames.add(baseDir + "Kartell - Pantera.mp3");
		audioFileNames.add(baseDir + "Mother Mother - Monkey Tree.mp3");
		audioFileNames.add(baseDir + "Nothing More - Jenny.mp3");
		audioFileNames.add(baseDir + "Oliver $ & Jimi Jules - Pushing On.mp3");
		audioFileNames.add(baseDir + "Ummet Ozcan - The Hum (LEGACY Remix) Dimitri Vegas & Like Mike.mp3");
		audioFileNames.add(baseDir + "Скриптонит - Грязные деньги ft. Niman.mp3");
	}
